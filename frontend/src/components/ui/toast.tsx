...
import { Cross2Icon } from "@radix-ui/react-icons"; // Close (X) icon
import * as ToastPrimitives from "@radix-ui/react-toast"; // Radix toast components
import { cva, type VariantProps } from "class-variance-authority"; // To manage class variants
import { cn } from "@/lib/utils"; // Utility to merge classNames conditionally

// ToastProvider: Wrap your app (or component tree) to provide context for toasts
...
// ===================
// Toast Action Button (optional button inside toast)
// ===================
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 " +
        "focus:outline-none focus:ring-1 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 " +
